/* Write an ES6 function that takes an array of objects containing Bollywood movie information (title, director, year, rating) and 
...
const getBestOldBollywoodMovies = (bollywoodMovies) =>
  bollywoodMovies
    .filter(({ year, rating }) => year < 1990 && rating > 8.0)
    .map(({ title }) => title);
