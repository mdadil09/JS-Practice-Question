...
properties name, price, and quantity, and returns the total cost of all the 
products using the reduce function. */
...
const getTotalCost = (products) =>
  products.reduce((accum, { price, quantity }) => accum + price * quantity, 0);
