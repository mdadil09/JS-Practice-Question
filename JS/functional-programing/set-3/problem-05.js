/* Write an ES6 function that takes an array of objects containing student information (name, age, grade) and 
...
const filterStudentsByGrade = (students, i) =>
  students.filter(({ grade }) => grade > i);
